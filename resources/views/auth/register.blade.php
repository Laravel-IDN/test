...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Register Pengunjung Baru') }}</div>
                    <small class="text-danger">*** Pastikan Data yang anda input Sesuai dengan KTP</small>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nama Pengunjung') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label><input type="radio" name="jenis_kelamin"> Laki-Laki</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Pas Foto') }}</label>

                                <div class="col-md-6">
                                    <input type="file" class="form-control" name="pas_photo" required>
                                </div>
                            </div>
