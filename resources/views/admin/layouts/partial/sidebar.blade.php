<nav id="sidebar" class="border">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item border">
            <a href="{{ route('monitoring.index') }}" class="nav-link {{ Str::contains(Route::currentRouteName(), 'monitoring.') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                     stroke-linejoin="round" class="feather feather-home">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                    <polyline points="9 22 9 12 15 12 15 22"></polyline>
                </svg> Monitoring <span class="sr-only">(current)</span>
            </a>
        </li>
        @endrole
        ...
        <li class="nav-item active border">
            ...
            <ul class="collapse list-unstyled {{ Str::contains(Route::currentRouteName(), 'setting.') ? 'show' : '' }}" id="homeSubmenu">
                ...
                <li class="nav-item">
                    <a href="{{ route('status.index') }}"  class="nav-link {{ Str::contains(Route::currentRouteName(), 'status.index') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>
                        Entry Status WBP
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('meja.index') }}"  class="nav-link {{ Str::contains(Route::currentRouteName(), 'meja.') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>
                        Entry Meja
                    </a>
                </li>
        ...
        <li class="nav-item active border">
            ...
            <ul class="collapse list-unstyled {{ Str::contains(Route::currentRouteName(), 'laporan.') ? 'show' : '' }}" id="laporanSubmenu">
                <li class="nav-item">
                    <a href="{{ route('laporan.f') }}" class="nav-link {{ Str::contains(Route::currentRouteName(), 'laporan.') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>
                        Laporan (Register F)
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('laporan.e') }}" class="nav-link {{ Str::contains(Route::currentRouteName(), 'laporan.') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>
                        Laporan (Register E)
                    </a>
                </li>
